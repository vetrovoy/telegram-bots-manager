export const en = {
  ...
  "Основные сведения профиля": "Profile Basics",
  "Изменить логин": "Change Username",
  "Изменить пароль": "Change Password",
  Язык: "Language",
  Русский: "Russian",
  Английский: "English",
  "Мои боты": "My Bots",
  "Управляйте всеми ботами из этой панели":
    "Manage all your bots from this panel",
  "Список моих ботов": "List of My Bots",
  "В данном меню отображается список всех ваших чат-ботов, которыми вы можете управлять":
    "This menu displays a list of all your chatbots that you can manage",
  Подробнее: "Learn More",
  "Общие боты": "Shared bots",
  "Список ботов, к которым вам предоставили доступ":
    "List of bots you have been granted access to",
